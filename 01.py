...
def proxima_palavra():
    global coisado, input_texto, vidas
...
while r:
    ...
    pygame.draw.rect(tela, verde, (100, 500, 150, 50))
    texto("PRÓXIMO", font1, preto, tela, 110, 510)

    pygame.draw.rect(tela, verde, (300, 500, 150, 50))
    texto("TEMA", font1, preto, tela, 310, 510)

    pygame.draw.rect(tela, verde, (500, 500, 150, 50))
    texto("ENCERRAR", font1, preto, tela, 510, 510)
